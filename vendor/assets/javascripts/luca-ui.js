(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/bootstrap_form_controls"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="btn-group form-actions">\n  <a class="btn btn-primary submit-button">\n    <i class="icon icon-ok icon-white"></i>\n    Save Changes\n  </a>\n  <a class="btn reset-button cancel-button">\n    <i class="icon icon-remove"></i>\n    Cancel\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/collection_loader_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="progress-modal" class="modal" style="display: none">\n  <div class="progress progress-info progress-striped active">\n    <div class="bar" style="width:0%;"></div>\n  </div>\n  <div class="message">Initializing...</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/form_alert"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="', className ,'">\n  <a class="close" href="#" data-dismiss="alert">x</a>\n  ', message ,'\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/grid_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="luca-ui-g-view-wrapper">\n  <div class="g-view-header"></div>\n  <div class="luca-ui-g-view-body">\n    <table class="luca-ui-g-view scrollable-table" width="100%" cellpadding=0 cellspacing=0>\n      <thead class="fixed"></thead>\n      <tbody class="scrollable"></tbody>\n      <tfoot></tfoot>\n    </table>\n  </div>\n  <div class="luca-ui-g-view-header"></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/grid_view_empty_text"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="empty-text empty-text-wrapper">\n  <p>', text ,'</p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/load_mask"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="load-mask">\n  <div class="progress progress-striped active">\n    <div class="bar" style="width:0%"></div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/nav_bar"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="navbar-inner">\n  <div class="luca-ui-navbar-body container">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/pagination"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="pagination">\n  <a class="btn previous">\n    <i class="icon icon-chevron-left"></i>\n  </a>\n  <div class="pagination-group">\n  </div>\n  <a class="btn next">\n    <i class="icon icon-chevron-right"></i>\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/components/table_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<thead></thead>\n<tbody class="table-body"></tbody>\n<tfoot></tfoot>\n<caption></caption>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/containers/basic"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="', id ,'" class="', classes ,'" style="', style ,'"></div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/containers/tab_selector_container"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="', cid ,'-tab-selector" class="tab-selector-container">\n  <ul id="', cid ,'-tabs-nav" class="nav nav-tabs">\n    '); for(var i = 0; i < components.length; i++ ) { __p.push('\n    '); var component = components[i];__p.push('\n    <li class="tab-selector" data-target="', i ,'">\n      <a data-target="', i ,'">\n        ', component.title ,'\n      </a>\n    </li>\n    '); } __p.push('\n  </ul>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/containers/tab_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul id="', cid ,'-tabs-selector" class="nav ', navClass ,'"></ul>\n<div id="', cid ,'-tab-view-content" class="tab-content"></div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/containers/toolbar_wrapper"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="luca-ui-toolbar-wrapper" id="', id ,'"></div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/button_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label>&nbsp;</label>\n<input style="', inputStyles ,'" class="btn ', input_class ,'" value="', input_value ,'" type="', input_type ,'" id="<%= input_id" />\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/button_field_link"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a class="btn ', input_class ,'">\n  '); if(icon_class.length) { __p.push('\n  <i class="', icon_class ,'"></i>\n  ', input_value ,'\n  '); } __p.push('\n</a>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/checkbox_array"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="control-group">\n  <label for="', input_id ,'"><%= label =>\n  <div class="controls"><div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/checkbox_array_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="', input_id ,'">\n  <input id="', input_id ,'" type="checkbox" name="', input_name ,'" value="', value ,'" />\n</label>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/checkbox_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="', input_id ,'">\n  ', label ,'\n  <input type="checkbox" name="', input_name ,'" value="', input_value ,'" style="', inputStyles ,'" />\n</label>\n\n'); if(helperText) { __p.push('\n<p class="helper-text help-block">\n  ', helperText ,'\n</p>\n'); } __p.push('\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/file_upload_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="', input_id ,'">\n  ', label ,'\n  <input type="file" name="', input_name ,'" value="', input_value ,'" style="', inputStyles ,'" />\n</label>\n\n'); if(helperText) { __p.push('\n<p class="helper-text help-block">\n  ', helperText ,'\n</p>\n'); } __p.push('\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/hidden_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push(' <input type="hidden" name="', input_name ,'" value="', input_value ,'" style="', inputStyles ,'" />\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/select_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="', input_id ,'">\n  ', label ,'\n</label>\n<div class="controls">\n <select name="', input_name ,'" value="', input_value ,'" style="', inputStyles ,'" ></select>\n  '); if(helperText) { __p.push('\n  <p class="helper-text help-block">\n    ', helperText ,'\n  </p>\n  '); } __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/text_area_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="', input_id ,'">\n  ', label ,'\n</label>\n<div class="controls">\n <textarea placeholder="', placeHolder ,'" name="', input_name ,'" style="', inputStyles ,'" >', input_value ,'</textarea>\n  '); if(helperText) { __p.push('\n  <p class="helper-text help-block">\n    ', helperText ,'\n  </p>\n  '); } __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["luca/templates/fields/text_field"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push(''); if(typeof(label)!=="undefined" && (typeof(hideLabel) !== "undefined" && !hideLabel) || (typeof(hideLabel)==="undefined")) {__p.push('\n<label class="control-label" for="', input_id ,'">', label ,'</label>\n'); } __p.push('\n\n<div class="controls">\n'); if( typeof(addOn) !== "undefined" ) { __p.push('\n  <span class="add-on">', addOn ,'</span>\n'); } __p.push('\n<input type="text" placeholder="', placeHolder ,'" name="', input_name ,'" style="', inputStyles ,'" value="', input_value ,'" />\n'); if(helperText) { __p.push('\n<p class="helper-text help-block">\n  ', helperText ,'\n</p>\n'); } __p.push('\n\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
...
(function() {
  ...
  Luca.util.argumentsLogger = function(prompt) {
    return function() {
      return console.log("" + prompt + " " + (typeof this.identifier === "function" ? this.identifier() : void 0), arguments);
    };
  };
  ...
  Luca.util.readAll = function(object) {
    var key, processed, value;
  ...
  Luca.util.rejectBlanks = function(object) {
    var key, processed, value;
    processed = {};
    for (key in object) {
      value = object[key];
      if (_.isBlank(value) !== true) processed[key] = value;
    }
    return processed;
  };
...
(function() {
  ...
  Luca.warn = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    if (Luca.config.showWarnings !== true) return;
    if (Luca.isComponent(this)) args.unshift(this.identifier());
...
(function() {
  ...
  Luca.util.deprecateComponent = function(previous, newName) {
    var msg, _base;
    msg = _.template("" + previous + " has been renamed to " + newName + ".  Please update your definitions.");
    (_base = Luca.registry.componentAliases)[newName] || (_base[newName] = []);
    Luca.registry.componentAliases[newName].push(previous);
    if (previous !== newName) {
      return Luca.registry.deprecatedComponents[previous] = {
        message: msg({
          previous: previous,
          newName: newName
        }),
  ...
  Luca.util.checkDeprecationStatusOf = function(componentName) {
    var replacement;
...
(function() {
  ...
  Luca.CollectionManager.loadCollectionsByName = function(set, callback) {
    ...
    for (_i = 0, _len = set.length; _i < _len; _i++) {
      name = set[_i];
      if (collection = this.getOrCreate(name)) {
        collection.on("reset", function() {
          callback(collection);
          return collection.unbind("reset", this);
        });
...
(function() {
  ...
  ComponentDefinition = (function() {
    ...
    ComponentDefinition.prototype.aliases = function() {
      var _aliases;
      _aliases = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      this._aliases = _aliases;
      this.meta("aliases", this._aliases);
      return this;
    };

    ComponentDefinition.prototype.replaces = function() {
      var old, replaces, _i, _len, _results;
      replaces = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      this._aliases || (this._aliases = []);
      _results = [];
      for (_i = 0, _len = replaces.length; _i < _len; _i++) {
        old = replaces[_i];
        this._aliases.push(old);
        _results.push(Luca.util.deprecateComponent(old, this.componentName));
      }
      return _results;
    };
    ...
    ComponentDefinition.prototype.definePrototype = function(properties) {
      var alias, at, componentType, definition, include, _base, _i, _j, _len, _len2, _ref, _ref2, _ref3, _ref4, _ref5;
      if (properties == null) properties = {};
      _.defaults((this.properties || (this.properties = {})), properties);
      ...
      if (_.isArray((_ref2 = this.properties) != null ? _ref2.include : void 0)) {
        _ref3 = this.properties.include;
      ...
      if (definition != null) {
        if ((_ref5 = definition.afterDefinition) != null) {
          _ref5.call(definition, this);
        }
      }
      return definition;
    };
...
(function() {
  ...
  Luca.registry.lookup = function(ctype) {
    ...
    if (alias = Luca.registry.typeAliases[ctype]) ctype = alias;
  ...
  Luca.cache = Luca.registry.cacheInstance = function(cacheKey, object) {
    var lookup_id;
...
(function() {
  var templateFn, templateId;

  Luca.templates || (Luca.templates = {});

  if (window.JST != null) {
    for (templateId in JST) {
      templateFn = JST[templateId];
      if (!(templateId.match(/^luca\/templates\//))) continue;
    ...
    __initializer: function() {
      ...
      if (this.collectionEventBindingsSetup !== true) {
        if (Luca.isBackboneCollection(this.collection)) {
          ...
          this.collection.on("change", relayAs("collection:change"), this);
          this.collection.on("before:fetch", relayAs("collection:fetch"), this);
        }
        return this.collectionEventBindingsSetup = true;
      }
    },
    __setup: function() {
  ...
  Luca.concerns.DomHelpers = {
    ...
    $template: function(template, variables) {
      ...
      try {
        ...
        return console.log("Error in $template: " + template + " " + (((_ref = typeof this.identifier === "function" ? this.identifier() : void 0) != null ? _ref : this.name) || this.cid));
      }
    },
...
(function() {
  ...
  Luca.concerns.Filterable = {
    classMethods: {
      prepare: function() {
        ...
        if (this.isRemote()) {
          ...
          return this.trigger("data:refresh");
        }
      }
    },
    ...
    __initializer: function(component, module) {
      ...
      if (this.filterable === true) this.filterable = {};
      if (!Luca.isBackboneCollection(this.collection)) {
      ...
      filter.on("change", function() {
        return _this.trigger("filter:change");
      });
      this.on("filter:change", Luca.concerns.Filterable.classMethods.prepare, this);
      return module;
    },
    prepareRemoteFilter: function(filter, options) {
      ...
      if (options.limit != null) {
        filter[Luca.config.apiLimitParameter] = options.limit;
      }
      if (options.page != null) {
        filter[Luca.config.apiPageParameter] = options.page;
      }
      if (options.sortBy != null) {
        filter[Luca.config.apiSortByParameter] = options.sortBy;
      }
      return filter;
    },
    isRemote: function() {
      var _ref;
      if (this.getQueryOptions().remote === true) return true;
      if (this.remoteFilterFallback === true && ((_ref = this.getCollection()) != null ? _ref.length : void 0) === 0) {
        return true;
      }
    },
    getFilterState: function() {
      var config, options, query, _base, _name, _ref;
      _ref = config = this.filterable || {}, options = _ref.options, query = _ref.query;
      if (!_.isEmpty(config) && (_.isEmpty(query) && _.isEmpty(options))) {
        _.extend(options, _(config).pluck('sortBy', 'page', 'limit'));
      }
      return (_base = this.collection.__filters)[_name = this.cid] || (_base[_name] = new FilterModel({
        query: query || {},
        options: options || {}
      }));
    },
  ...
  FilterModel = (function(_super) {
    ...
    FilterModel.prototype.toOptions = function() {
      return _.clone(this.toJSON().options);
    };

    FilterModel.prototype.toQuery = function() {
      return _.clone(this.toJSON().query);
    };

    FilterModel.prototype.toRemote = function() {
      return Luca.concerns.Filterable.prepareRemoteFilter.call(this, this.toQuery(), this.toOptions());
    };
...
(function() {
  ...
  Luca.concerns.LoadMaskable = {
    __initializer: function() {
      var _this = this;
      if (this.loadMask === false || !(this.loadMask != null)) return;
      ...
      this.on("collection:fetch", function() {
        return _this.trigger("enable:loadmask");
      });
      this.on("collection:reset", function() {
        return _this.trigger("disable:loadmask");
      });
      this.on("after:render", function() {
        this.$el.addClass('with-mask');
        if (this.$('.load-mask').length === 0 && (this.loadMaskTemplate != null)) {
          this.loadMaskTarget().prepend(Luca.template(this.loadMaskTemplate, this));
          return this.$('.load-mask').hide();
        }
      }, this);
      this.on(this.loadMask.enableEvent, this.applyLoadMask, this);
      return this.on(this.loadMask.disableEvent, this.applyLoadMask, this);
    },
...
(function() {
  ...
  Luca.concerns.Paginatable = {
    ...
    __initializer: function() {
      var collection, paginationState,
        _this = this;
      if (this.paginatable === false) return;
      if (_.isNumber(this.paginatable) || _.isString(this.paginatable)) {
        this.paginatable = {
          limit: parseInt(this.paginatable),
          page: 1
        };
      }
      if (!Luca.isBackboneCollection(this.collection)) {
      ...
      collection = (this.getCollection || (this.getCollection = function() {
        return this.collection;
      }))();
      ...
      paginationState.on("change:page", function() {
        return _this.trigger("pagination:change");
      });
      this.on("pagination:change", Luca.concerns.Filterable.classMethods.prepare, this);
...
(function() {
  ...
  Luca.concerns.QueryCollectionBindings = {
    ...
    getQuery: function(options) {
      ...
      return Luca.util.readAll(query);
    },
    getQueryOptions: function(options) {
      var optionSource, queryOptions, _i, _len, _ref;
      if (options == null) options = {};
      queryOptions = this.queryOptions || (this.queryOptions = {});
    ...
    getModels: function(query, options) {
      ...
      if ((_ref = this.collection) != null ? _ref.query : void 0) {
        ...
        options.prepare || (options.prepare = this.prepareQuery);
...
(function() {
  ...
  Luca.concerns.Sortable = {
    ...
    __initializer: function() {
      var collection, sortableState,
        _this = this;
      if (this.sortable === false) return;
      if (_.isString(this.sortable)) {
        this.sortable = {
          sortBy: this.sortable
        };
      }
      if (!Luca.isBackboneCollection(this.collection)) {
        this.debug("Skipping Sortable due to no collection being present on " + (this.name || this.cid));
        this.debug("collection", this.collection);
        return;
      }
      collection = (this.getCollection || (this.getCollection = function() {
      ...
      sortableState = this.getSortableState();
      this.optionsSources || (this.optionsSources = []);
      this.queryOptions || (this.queryOptions = {});
      this.optionsSources.push(function() {
        return _(sortableState.toJSON()).pick('sortBy', 'order');
      });
      sortableState.on("change", function() {
        return _this.trigger("sortable:change");
      });
      this.defer(function() {
        return _this.$(".sortable-toggle").on("click", function(e) {
          var me, my;
          me = my = _this.$(e.target);
          me = my = my.closest('.sortable-toggle');
          return _this.toggleSortOrderDirection(my.data('sortableSortBy'));
        });
      }).until("after:render");
      return this.on("sortable:change", Luca.concerns.Filterable.classMethods.prepare, this);
    },
    isRemote: function() {
      return this.getQueryOptions().remote === true;
    },
    getSortableState: function() {
      var options, _base, _name;
      options = _(this.sortable || {}).pick('sortBy', 'order');
      return (_base = this.collection.__sortables)[_name = this.cid] || (_base[_name] = new SortableState(options));
    },
    sortBy: function(field, order) {
      if (field != null) this.setSortBy(field);
      if (order != null) this.setOrder(order);
      return this;
    },
    setSortBy: function(field, options) {
      if (options == null) options = {};
      this.getSortableState().set('sortBy', field, options);
      return this;
    },
    toggleSortOrderDirection: function(sortBy) {
      var changeTo, current;
      current = this.getSortableState().get('order') || "ASC";
      changeTo = current === "ASC" ? "DESC" : "ASC";
      sortBy || (sortBy = this.getSortableState().get('sortBy'));
      return this.sortBy(sortBy, changeTo);
    },
    setOrder: function(order, options) {
      if (options == null) options = {};
      this.getSortableState().set('order', order, options);
      return this;
    }
  };

  Luca.util.makeSortableToggleElement = function(el, sortBy, order) {
    ...
    __initializer: function() {
      ...
      if (template = this.bodyTemplate) {
        ...
        try {
          ...
          console.log("Error Rendering " + bodyTemplate + " in View: " + ((typeof this.identifier === "function" ? this.identifier() : void 0) || this.name || this.cid));
        }
  ...
  collection.defines({
    ...
    query: function(filter, options) {
      ...
      if (Backbone.QueryCollection != null) {
        if (_.isFunction(prepare = options.prepare || this.prepareQuery)) {
          filter = prepare(filter);
        }
        return Backbone.QueryCollection.prototype.query.call(this, filter, options);
      } else {
        return this.models;
      }
    }
...
(function() {
  ...
  view.defines({
    identifier: function() {
      return (this.displayName || this.type) + ":" + (this.name || this.role || this.cid);
    },
    initialize: function(options) {
      ...
      Luca.registry.cacheInstance(this.cid, this);
      this.setupHooks(_(Luca.View.prototype.hooks.concat(this.hooks)).uniq());
      Luca.concern.setup.call(this);
      this.delegateEvents();
      this.trigger("after:initialize", this);
      if (((_ref = this.bindMethods) != null ? _ref.legth : void 0) > 0) {
        return _.bindAll.apply(_, [this].concat(__slice.call(this.bindMethods)));
      }
    },
    ...
    registerEvent: function(selector, handler) {
      ...
      if (_.isObject(selector)) _.extend(this.events, selector);
      return this.delegateEvents();
    },
    ...
    debug: function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (this.debugMode === true || window.LucaDebugMode === true) {
...
(function() {
  ...
  container.defines({
    ...
    initialize: function(options) {
      ...
      this.setupHooks(Luca.Container.prototype.hooks);
    ...
    beforeRender: function() {
      ...
      return (_ref = Luca.Panel.prototype.beforeRender) != null ? _ref.apply(this, arguments) : void 0;
    },
  ...
  Luca.Container.componentRenderer = function(container, component) {
    var attachMethod;
...
(function() {
  ...
  component.defaults({
    ...
    prepareComponents: function() {
      var _ref;
      if ((_ref = Luca.Container.prototype.prepareComponents) != null) {
        _ref.apply(this, arguments);
      }
...
(function() {
  ...
  collectionView.defines({
    initialize: function(options) {
      ...
      this.on("data:refresh", this.refresh, this);
      this.on("collection:reset", this.refresh, this);
      this.on("collection:remove", this.refresh, this);
      this.on("collection:add", this.refresh, this);
      if (this.observeChanges === true) {
        this.on("collection:change", this.refreshModel, this);
      }
      Luca.Panel.prototype.initialize.apply(this, arguments);
      view = this;
...
(function() {
  ...
  formView.privateMethods({
    ...
    afterComponents: function() {
      var form, _ref;
      if ((_ref = Luca.Container.prototype.afterComponents) != null) {
        _ref.apply(this, arguments);
      }
      form = this;
    ...
    getValues: function(options) {
      ...
      values = _(this.getFields()).inject(function(memo, field) {
        ...
        if (field.includeBlank === true || _this.includeBlankValues === true) {
...
(function() {
  ...
  _.def('Luca.components.GridView').extend('Luca.Panel')["with"]({
    ...
    beforeRender: function() {
      var _ref;
      if ((_ref = Luca.Panel.prototype.beforeRender) != null) {
        _ref.apply(this, arguments);
      }
    ...
    afterRender: function() {
      var _ref;
      if ((_ref = Luca.Panel.prototype.afterRender) != null) {
        _ref.apply(this, arguments);
      }
      this.rendered = true;
      this.refresh();
...
(function() {
  ...
  multiView.mixesIn("QueryCollectionBindings", "LoadMaskable", "Filterable", "Paginatable", "Sortable");
  ...
  multiView.private({
    ...
    initialize: function(options) {
      ...
      return this.on("after:components", Luca.components.MultiCollectionView.propagateCollectionComponents, this);
    },
    ...
    refresh: function() {
      var _ref;
      return (_ref = this.activeComponent()) != null ? _ref.refresh() : void 0;
    }
  });
  ...
  multiView.classMethods({
    propagateCollectionComponents: function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (container.prepareQuery != null) {
...
(function() {
  ...
  paginationControl.defines({
    ...
    onPageCountChange: function() {
      return this.updateWithPageCount(this.get('numberOfPages'));
    },
    limit: function() {
      var _ref;
      return parseInt(this.get('limit') || ((_ref = this.collection) != null ? _ref.length : void 0));
    },
    page: function() {
    ...
    setPage: function(page, options) {
      if (page == null) page = 1;
      if (options == null) options = {};
      return this.set('page', page, options);
    },
    setLimit: function(limit, options) {
      if (limit == null) limit = 1;
      if (options == null) options = {};
      return this.set('limit', limit, options);
    },
...
(function() {
  ...
  tableView.privateMethods({
    ...
    eachColumn: function(fn, scope) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        col = _ref[_i];
        _results.push(fn.call(scope, col, index++, this));
      }
      return _results;
    },
  ...
  tableView.classMethods({
    renderHeader: function(columns, targetElement) {
      var attrs, column, content, index, th, _i, _j, _len, _len2, _results;
      index = 0;
      this.$(targetElement).append("<tr></tr>");
