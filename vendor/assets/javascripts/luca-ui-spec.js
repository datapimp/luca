(function() {
  ...
  Luca.supportsBackboneEvents = function(obj) {
...
(function() {
  ...
  customizeRender = function(definition) {
    ...
    definition.render = function() {
      var deferredRender, fn, _base2, _name,
        _this = this;
      if (this.deferrable && Luca.supportsBackboneEvents(this.deferrable)) {
  ...
  _.def('Luca.core.Container')["extends"]('Luca.View')["with"]({
    ...
    beforeRender: function() {
      ...
      if (this.hasBody || this.topToolbar || this.bottomToolbar) {
        this.bodyTagName || (this.bodyTagName = "div");
        this.bodyClassName || (this.bodyClassName = "view-body");
        this.$append(this.make(this.bodyTagName, {
...
(function() {
  ...
  describe("Luca.View", function() {
    ...
    return it("should be picked up by the supportsBackboneEvents helper", function() {
      var view;
      view = new Luca.View();
  ...
  describe('The Body Element', function() {
    return it("should have a separate body element", function() {
      var view;
      view = new Luca.View({
        bodyClassName: "panel"
      });
      return expect(view.$el.is('.panel')).toEqual(false);
    });
  });

  describe("DOM Helper Methods", function() {
    it("should use the $html method to inject into the $el", function() {
      var view;
      view = new Luca.View();
      view.$html('haha');
      return expect(view.$html()).toEqual('haha');
    });
    return it("should use the $html method to inject into the $bodyEl", function() {
      var view;
      return view = new Luca.View({
        bodyClassName: "body"
      });
    });
  });
  ...
  describe("Deferrable Rendering", function() {
    ...
    return it("should automatically call fetch on the collection once render is called", function() {
      this.view.render();
      return expect(this.spy).toHaveBeenCalled();
    });
  });

  describe("The Render Wrapper", function() {});
